export const topTaskSection = {
  ...
  tasks: [
    ...
    },
    {
      ...
      description:
        "Vraag deze bewijzen aan of verleng ze. Geef een vermissing aan.",
    },
    {
      title: "Onderwijs",
      description:
...
export const spotlightBlocks = [
  ...
  },
  {
    title: "Werkzaamheden",
    description:
      "Lees waar en wanneer we werken aan nieuwbouw, groot onderhoud, herinrichting van straten en wegen, aanpak van parken of ontwikkeling van hele gebieden.",
    link: "Alle bouw- en verkeerswerkzaamheden",
  },
];
